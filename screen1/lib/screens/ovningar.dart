    ...
    return MaterialApp(
      ...
      home: Stack(
        children: [
          ...
          ///end
          MediaMusicScreen(title:' ovingarListModel',image: 'assets/images/logo.png',subline: 'ovingarListModel.subtileText',),
          Text(ovingarListModel.images),
